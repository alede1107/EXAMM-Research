...
exp_name="/anvil/projects/x-cis251123/aperdomo/results/701515_split_250/JKHY/lr_$lr/max_genome_$MAX_GENOME/island_$NUM_ISLAND/$FOLDER"
mkdir -p "$exp_name"
